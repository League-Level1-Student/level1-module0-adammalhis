...
public class DrumKit implements MouseListener {
	...
	public void run() throws MalformedURLException {
		...
		String picture= ("Drum Kit.jpg");
		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(picture);
		
		// 10. Add the image to the panel
		tod.add(drumLabelWithImage);
		// 11. Set the layout of the panel to "new GridLayout()"
		tod.setLayout(new GridLayout());
		...
		String picture2= ("DrumKit2.jpg");
		drumLabelWithImage2 = createLabelImage(picture2);
		tod.add(drumLabelWithImage2);
		tod.setLayout(new GridLayout());
		bob.pack();
